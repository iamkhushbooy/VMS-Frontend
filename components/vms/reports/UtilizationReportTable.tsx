      ...
      <div className="mb-6 flex flex-col gap-3 rounded-2xl border border-gray-100 bg-white p-4 shadow-sm xl:flex-row xl:items-end xl:justify-between">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
          <Button
            ...
            className="h-10 rounded-xl bg-white border-gray-200 text-gray-700 hover:bg-gray-50 shadow-sm"
          >
            Today
          </Button>
          <Button
            ...
            className="glow-button-pink text-white font-semibold h-10 rounded-xl"
          >
            {isLoading ? "Generating..." : "Generate Report"}
          </Button>
        </div>
